...
for edit layout use https://nickcoutsos.github.io/keymap-editor/

after get a firmware, double tab in corne reset button and than paste the correct file inside th oppened folder
